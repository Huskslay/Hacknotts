...
class Generation(Object):
    def __init__(self) -> None:
        ...
        self.tilemaps.add_tilemap("ladder", "Assets\\Environment\\Ladder.png", TILE_SCALE, [[TileEnum.FLOOR, TileEnum.FLOOR]])
        self.tilemaps.add_tilemap("hole", "Assets\\Environment\\Hole.png", TILE_SCALE, [[TileEnum.FLOOR, TileEnum.FLOOR]])
